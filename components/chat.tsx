...
export default function Chatbot({ isDark = false }: ChatbotProps) {
    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            id: '1',
            text: "Hi there! ✨ I'm AkriBot, Akriti's digital twin. I can tell you all about her data science experiments, her life in Tokyo, or her soul vision. What's on your mind?",
            sender: 'bot',
            timestamp: new Date()
        }
    ]);
    ...
    const callGeminiAPI = async (prompt: string): Promise<string> => {
        ...
        if (!GEMINI_API_KEY) {
            return "I'm currently in 'offline meditation' mode (API key missing). But I can tell you that Akriti is an IIT Mandi graduate and a Data Scientist at Accenture Japan who loves mixing math with magic!";
        }
        ...
        try {
            ...
            const systemPrompt = `You are AkriBot, a witty, sophisticated, and friendly AI assistant representing Akriti, a Data Scientist. 

About Akriti:
- Role: Data Scientist at Accenture Japan (Lead Analyst FY25).
- Education: B.Tech in Data Science from IIT Mandi (2019-2023). Dakshana Scholar.
- Location: Currently living in Tokyo, Japan. 
- Expertise: Python, SQL, AWS (Athena/Cloud), Generative AI research, Machine Learning, Automation, and Data Visualization.
- Hobbies: Creative writing, painting, cinematography, hiking, fashion design, business/finance, crochet, drinking tea, and spiritual learning.
- Personal Style: Her portfolio uses a "Girlish Pink & Neon" aesthetic. She mixes "Math and Magic."
- Soul Vision: Deepening expertise in analytics/automation and transitioning into consulting leadership.
- Key Achievements: 47th place out of 73,000 in TechGig Geek Goddess, Top Performer in GSSOC'21, 5-star coder on Hackerrank, solved 550+ Leetcode problems.
- Important : If asked who created you, Answer --> Akriti
Tone & Instructions:
- Be helpful, professional yet playful, and deeply insightful.
- Use words like "magic," "precision," "soul," and "data-driven."
- Use sparkle (✨) and star (⭐) emojis occasionally.
- Help users learn about Akriti's work experience, her projects, her skills, and how to connect with her.
- If asked about her location, mention she's crushing code in Tokyo.
- Keep responses concise but engaging.
- Do not use markdown headers; use bolding for emphasis if needed.
- If you don't know an answer, suggest they reach out to Akriti via the "Connect" button.
...
User query: ${prompt}`;
            ...
            return "Oops! My neural circuits caught a little sparkle. Akriti is probably busy lead-analyzing something great, but I can tell you she specializes in GenAI and Machine Learning!";
        }
    };
                        ...
                        <div className="bg-gradient-to-r from-neon-pink to-neon-purple p-6 flex items-center justify-between relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-3 relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/80 text-[10px] font-black uppercase tracking-[0.2em]">Data Scientist twin</p>
                                </div>
                            </div>
                                        ...
                                        >
                                            <div className={`max-w-[85%] p-4 rounded-3xl text-sm shadow-sm ${message.sender === 'user'
                                                ...
                                                <div className={`flex items-center gap-2 mb-1 opacity-60 text-[10px] uppercase font-black tracking-widest ${message.sender === 'user' ? 'justify-end' : 'justify-start'
                                                    ...
                                                    {message.sender === 'user' ? 'Me' : 'AkriBot'}
                                                </div>

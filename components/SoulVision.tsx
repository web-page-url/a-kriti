    ...
    const goals = [
        {
            ...
            desc: "Deepen expertise in advanced analytics, machine learning, and automation workflows for management cockpits."
        },
        {
            type: "Long-Term",
            icon: <TrendingUp className="h-6 w-6 text-neon-purple" />,
            desc: "Transition into consulting leadership roles, applying data science across industries to drive innovation."
        }
    ];
                    ...
                    >
                        ...
                        <div className="pt-8 border-t border-white/40">
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    <p className="font-black text-berry text-lg">Strategy First.</p>
                                    <p className="text-berry/50 font-bold uppercase text-xs tracking-widest">Always customer-centric.</p>
                                </div>
                            </div>
                        </div>
                    </motion.div>
